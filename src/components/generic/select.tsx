...
export const Select = <T extends ValueT = ValueT>({
    ...
    return (
        <select
            ...
            className={cn(
                'py-1.5 pl-3 pr-8 bg-zinc-800 text-zinc-100 rounded-lg border border-zinc-700',
                'text-ellipsis min-w-32 font-medium text-sm leading-none focus:border-zinc-700',
